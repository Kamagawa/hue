...
import me.eugenewang.hue.jsoup.nodes.Comment;
import me.eugenewang.hue.jsoup.nodes.Document;
import me.eugenewang.hue.jsoup.nodes.DocumentType;
import me.eugenewang.hue.jsoup.nodes.Element;
import me.eugenewang.hue.jsoup.nodes.Node;
import me.eugenewang.hue.jsoup.nodes.XmlDeclaration;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static me.eugenewang.hue.jsoup.internal.Normalizer.lowerCase;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<me.eugenewang.hue.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (me.eugenewang.hue.jsoup.nodes.Attribute attribute : values) {
