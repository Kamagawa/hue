...
import me.eugenewang.hue.jsoup.nodes.FormElement;
...
public class Elements extends ArrayList<Element> {
     ...
     * <p>
     * Note that this method should not be used to clean user-submitted HTML; rather, use {@link me.eugenewang.hue.jsoup.safety.Cleaner} to clean HTML.
     * @return this, for chaining
     * @see Element#empty()
     * @see #empty()
     */
